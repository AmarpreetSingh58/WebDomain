...
<body>
	<center style="margin-left: 100px; padding-top: 10px;">
		<div class="container"
			style="background-color: #ffffff; min-height: 100%; min-width: 100%">
		...
		<br/>
			<form action="InteractionHandler" method="post">
				<input type="hidden" value="phonenumber" name="action" /> <input
					...
					id="phonenumber" placeholder="Enter phone number" size="50"><br/> <br/><input
					class="btn btn-primary" type="submit" value="Search Contact Info" /><br/>	
			</form>
			<button type="button" class="btn btn-outline-info">
				<a href="index.jsp">Search Keyword</a>
			</button>
			<button type="button" class="btn btn-outline-info">
				<a href="pincodes.jsp">Search Postalcodes</a>
			</button>
			<br /><br/>
			<%
