		...
		<div class="container"
			...
			<form action="InteractionHandler" method="post">
				<input type="hidden" value="pincode" name="action" /> <input
					type="text" name="city" id="city" placeholder="Enter City" size="50"> <br />
				<br />
				<input class="btn btn-primary" type="submit" value="Get Postalcodes" />
			</form>
			<button type="button" class="btn btn-outline-info">
				<a href="index.jsp">Search Keyword</a>
			</button>
			<button type="button" class="btn btn-outline-info">
				<a href="phonenumber.jsp">Contact info</a>
			</button>
			<br />
			<br />
			<%
