	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("index")) {
			...
			if (keyword != null && !keyword.equals("")) {
				List<Entry<String, Integer>> files = new FolderSearch(
						"C:\\Users\\amarp\\eclipse-workspace\\WebDomain\\src\\text").search(keyword);
				if (files.size() != 0) {
			...
			if (phonenumber != null && !phonenumber.equals("")) {
				...
				if (r.matcher(phonenumber).matches()) // pattern matching
				{
					...
					List<String> files = new FolderSearch(
							"C:\\Users\\amarp\\eclipse-workspace\\WebDomain\\src\\text\\")
