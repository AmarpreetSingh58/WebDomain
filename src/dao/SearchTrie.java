...
public class SearchTrie<Value> {
	...
	public List<Entry<String, Integer>> search(String search) throws IOException {
		...
		String txt = null;
		//File[] files = new File("C:\Users\amarp\eclipse-workspace\WebDomain\src\text").listFiles();
		File[] files = new File("C:\\Users\\amarp\\eclipse-workspace\\WebDomain\\src\\webpages").listFiles();
